...
[Y, FS] = audioread("VogaisLocutor1/TesteA.wav");
...
[Y, FS] = audioread("VogaisLocutor1/TesteI.wav");
Y = Y(:,1);
...
[Y, FS] = audioread("VogaisLocutor1/TesteO.wav");
Y = Y(:,1);
...
[Y, FS] = audioread("VogaisLocutor1/TesteU.wav");
Y = Y(:,1);
